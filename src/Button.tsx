...
const applyStyle = (ButtonWrapper?: (props: ButtonProps) => JSX.Element) => {
  return (
    ButtonWrapper &&
...
type AppearanceKeys = keyof typeof APPEARANCES;
type AppearanceValues = typeof APPEARANCES[AppearanceKeys];
type SizesKeys = keyof typeof SIZES;
type SizesValues = typeof SIZES[SizesKeys];
...
export interface ButtonProps {
  ...
  */
  ...
  size?: SizesValues;
  ButtonWrapper?: (props: ButtonProps) => JSX.Element;
  href?: string;
}
